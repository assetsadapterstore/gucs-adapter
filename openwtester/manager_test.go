...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO GUCS", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WLCL9JUiYA8jLVhH2kjVZduofZovf4yo3A")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WLCL9JUiYA8jLVhH2kjVZduofZovf4yo3A"
	account := &openwallet.AssetsAccount{Alias: "GUCS", WalletID: walletID, Required: 1, Symbol: "GUCS", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	accountID := "A7JDAgYxo9fU2PoFg6YWHpntnBS91xFAbqX3B7jcifPA"
